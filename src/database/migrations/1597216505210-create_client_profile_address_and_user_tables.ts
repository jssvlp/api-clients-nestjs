...
export class createClientProfileAddressAndUserTables1597216505210 implements MigrationInterface {
    name = 'createClientProfileAddressAndUserTables1597216505210'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `profiles` (`id` int NOT NULL AUTO_INCREMENT, `email` varchar(100) NOT NULL, `username` varchar(25) NOT NULL, `password` varchar(100) NOT NULL, `status` varchar(8) NOT NULL DEFAULT 'active', `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX `IDX_5b49bd22c967ce2829ca8f1772` (`email`), UNIQUE INDEX `IDX_d1ea35db5be7c08520d70dc03f` (`username`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
